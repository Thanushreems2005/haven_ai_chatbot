...
CRISIS_MESSAGES = {
    ...
    "SEVERE_DISTRESS": (
        ...
        "Your feelings are valid, and I'm here to listen.Would you like to talk about what's causing this distress?"
        "Would you like me to suggest a exercise or activity to help you cope with this distress? "
    )
}
...
def handle_boredom(user_input):
    ...
    if choice == "joke":
        ...
        return handle_give_me_an_exercise(user_input)
    else:
...
def handle_crisis_suicidal(user_input):
    return CRISIS_MESSAGES["SUICIDAL_THOUGHTS"], "CRISIS_SUICIDAL"
...
def _check_for_crisis_intents(classification_results):
    ...
    top_n = min(3, len(classification_results['labels']))
...
def get_structured_response(user_input):
    ...
    intent_handlers = {
        ...
        "severe distress": handle_crisis_severe_distress,
        "overwhelming stress": handle_overwhelming_stress,
        "depressive episode": handle_depressive_episode,
        ...
        "feeling sad all the time": handle_feeling_sad_all_the_time,
        ...
        "am i depressed or sad": handle_depressed_or_sad_diff,
        ...
        "bad day calm down": handle_bad_day_calm_down,
        ...
        "general positive mood": handle_general_positive_mood,
        "tell me a joke": handle_tell_me_a_joke,
        "give me an exercise": handle_give_me_an_exercise
    }
    ...
    try:
        ...
        if detected_crisis_intent:
            ...
            if crisis_response:
                ...
                response_text = CRISIS_MESSAGES["SEVERE_DISTRESS"]
        ...
        if top_score >= CONFIDENCE_THRESHOLD:
            if top_prediction in intent_handlers:
                ...
                if intent_tag in ["COPING_PANIC", "EXERCISE_ANGER_STEP1", "COPING_ADHD", "COPING_QuickCalmAnxietyAttack"]:
                    session_data_updates['exercise_state'] = {'type': intent_tag, 'current_step': 'step1'}
    ...
    if exercise_type == "EXERCISE_ANGER_STEP1":
        if current_step_key == "step1":
            if "yes" in user_input_lower or "try" in user_input_lower:
                ...
                response_text = current_step_details["prompt"]
        ...
        if current_step_key == "step1":
            if "yes" in user_input_lower or "breathing" in user_input_lower:
                ...
                exercise_state['type'] = "COPING_QuickCalmAnxietyAttack"
                exercise_state['current_step'] = "step1"
